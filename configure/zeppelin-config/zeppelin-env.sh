...
#
 ...
 export SPARK_HOME=/home/hadoop/spark                             # (required) When it is defined, load it instead of Zeppelin embedded Spark libraries
 export HADOOP_CONF_DIR=/home/hadoop/hadoop/etc/hadoop         		# yarn-site.xml is located in configuration directory in HADOOP_CONF_DIR.
